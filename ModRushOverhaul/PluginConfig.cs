...
namespace ModRushOverhaul {
    public class PluginConfig {
        ...
        public PluginConfig(Plugin BindingPlugin) {
            ...
            usePremiumBatterys = BindingPlugin.Config.Bind<bool>("ModRush Overhaul", "mroUsePremiumBatterys", true, "Should the Company buy premium batterys?\ntrue = yes / false = no").Value;
            useStaminaRework = BindingPlugin.Config.Bind<bool>("ModRush Overhaul", "mroUseStaminaRework", true, "You want to use a Gym subscribtion?\ntrue = yes / false = no").Value;
